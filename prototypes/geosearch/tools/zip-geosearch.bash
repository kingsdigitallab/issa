cd ../..
find -L geosearch -type f \( -name "*.webm" -o -name "*.jpg" -o -name "*.html" -o -name "transcription_answers.json" -o -name "index_*.json" -o -name "frames.json" \) -print0 | xargs -0 zip -r geosearch-$(date +%Y%m%d).zip
# Instructions
