'''
Objectives: test how a VLM can audio describe a 10 min video as a single input
...
PROMPT = '''Return a valid JSON array of Audio Descriptions for visually impaired audience to understand what is happening in this video.
